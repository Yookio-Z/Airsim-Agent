...
TOOL_MANIFEST: dict[str, ToolManifestEntry] = {
    ...
    "drone_arm": _atomic("drone_arm", "core", "vehicle_command", ("flight_control",)),
    "drone_disarm": _atomic("drone_disarm", "core", "vehicle_command", ("flight_control",)),
    "drone_takeoff": _atomic("drone_takeoff", "core", "vehicle_command", ("flight_control",)),
    "drone_land": _atomic("drone_land", "core", "vehicle_command", ("flight_control",)),
    "drone_hover": _atomic("drone_hover", "core", "vehicle_command", ("flight_control",)),
    "drone_fly_to": _atomic("drone_fly_to", "core", "vehicle_command", ("flight_control",)),
    "drone_move_relative": _atomic(
        "drone_move_relative",
        "core",
        "vehicle_command",
        ("flight_control", "telemetry"),
        notes="Small convenience wrapper over telemetry plus absolute local movement.",
    ),
    "drone_fly_velocity": _atomic(
        ...
        "vehicle_command",
        ("flight_control",),
        notes="Low-level command; skills should bound duration and speed.",
    ),
    "drone_rotate_to": _atomic("drone_rotate_to", "core", "vehicle_command", ("flight_control",)),
    ...
    "drone_fly_path": _atomic(
        ...
        "mission",
        ("flight_control",),
        notes="Local NED path execution. Complex path planning belongs in skills or planners.",
    ),
