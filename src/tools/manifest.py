...
TOOL_MANIFEST: dict[str, ToolManifestEntry] = {
    ...
    "drone_dispatch_takeoff": _atomic(
        "drone_dispatch_takeoff",
        "core",
        "vehicle_command",
        ("flight_control",),
        notes="vehicle_name: 空=默认机, all=全部, 或具体载具名; Non-blocking takeoff dispatch (fire-and-forget) for parallel multi-vehicle launches.",
    ),
    "drone_dispatch_path": _atomic(
        "drone_dispatch_path",
        "core",
        "mission",
        ("flight_control",),
        notes="vehicle_name: 空=默认机, all=全部, 或具体载具名; Non-blocking local NED path dispatch (fire-and-forget) so each vehicle can fly its own route simultaneously.",
    ),
    "drone_dispatch_land": _atomic(
        "drone_dispatch_land",
        "core",
        "vehicle_command",
        ("flight_control",),
        notes="vehicle_name: 空=默认机, all=全部, 或具体载具名; Non-blocking land dispatch (fire-and-forget) for parallel multi-vehicle landings.",
    ),
    "drone_dispatch_return_land": _atomic(
        "drone_dispatch_return_land",
        "core",
        "vehicle_command",
        ("flight_control",),
        notes="vehicle_name: 空=默认机, all=全部, 或具体载具名; Non-blocking return-to-point then auto land + disarm (full RTL semantics).",
    ),
